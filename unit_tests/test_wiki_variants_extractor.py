...
def main():
    ...
    for title in expected_wiki_variants:
        ...
        contains_variants = expected_wiki_variants[title]["Contains"] if "Contains" in expected_wiki_variants[title] else []
        excludes_variants = expected_wiki_variants[title]["Excludes"] if "Excludes" in expected_wiki_variants[title] else []
