...
GET_URL = lambda letter: f"https://premium-oxforddictionaries-com.offcampus.lib.washington.edu/us/browse/american_english/{letter}/"
...
def main():
    ...
    scrape(GET_URL, targets, extract_targets, PREMIUM_OXFORD_WORD_LIST_TARGETS_DIR, headers={
